...
extension SingleViewController: UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let celID = "FullRecipeCell"
        let cell = self.tableView.dequeueReusableCell(withIdentifier: celID, for: indexPath) as! FullRecipeCell //se reutilizan las cells, solo carga en memoria las que son visibles para el usuario
